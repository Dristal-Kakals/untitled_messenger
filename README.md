...
- **Sidebar search** — a search/filter box ranks contacts and groups by match quality (exact > prefix > substring, nickname hits above pasted-pubkey hits) and highlights the matched fragment of the nickname / group name with an accent wash.
